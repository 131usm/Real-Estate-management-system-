        ...
        <div class="columns is-multiline">
            ...
            <div class="column is-one-third">
                <div class="card">
                    ...
                    <div class="card-content">
                        <p class="title is-4">Utility Company A</p>
                        <p class="subtitle is-6">Providing electricity, gas, and water services</p>
                    </div>
                </div>
            </div>
            ...
            <div class="column is-one-third">
                <div class="card">
                    ...
                    <div class="card-content">
                        <p class="title is-4">Recycling Waste Company B</p>
                        <p class="subtitle is-6">Eco-friendly waste management solutions</p>
                    </div>
                </div>
            </div>
            ...
            <div class="column is-one-third">
                <div class="card">
                    ...
                    <div class="card-content">
                        <p class="title is-4">Local Amenity C</p>
                        <p class="subtitle is-6">Community center offering various services</p>
                    </div>
                </div>
            </div>
        </div>
